...
\begin{itemize}
  \item \textbf{3 test} in \texttt{FDCDomainTests} (package SPM)
  \item \textbf{22 test} nel target app (inclusi \texttt{PathfindingTests})
\end{itemize}

\section{Prossimi passi (Fase 7)}

\begin{itemize}
  \item Ridurre \texttt{DomainBridge} typealias; import espliciti dove serve
  \item \texttt{NetworkModel} come shell \texttt{@Observable} pura
